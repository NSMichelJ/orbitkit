    ...
    <PreviewCard>
      <Tab class="w-full max-w-xs p-4 border-border border bg-surface rounded-lg">
        ...
        <TabContent value="Standard">
          <div class="p-4">
            <h2 class="text-lg font-bold mb-2">Standard Plan</h2>
            <p class="mb-2">
            ...
            <div class="text-2xl font-semibold mb-2">$3.99/month</div>
            <button class="bg-blue-600 text-white px-4 py-2 rounded">Choose Standard</button>
          </div>
        </TabContent>
        <TabContent value="Pro">
          <div class="p-4">
            <h2 class="text-lg font-bold mb-2">Pro Plan</h2>
            <p class="mb-2">Perfect for businesses and growing projects.</p>
            <ul class="mb-4 list-disc list-inside">
            ...
            <div class="text-2xl font-semibold mb-2">$9.99/month</div>
